...
public class PointTest {
	...
	public void itShouldSerializeASFPoint() throws Exception {
		...
		TestUtils.compareAsNodes(point, "{\"type\":\"Point\",\"coordinates\":[100.0,10.0]}");
	}
	...
	public void itShouldDeserializeAPointWithAltitude() throws Exception {
		GeoJsonObject value = TestUtils.getMapper().readValue("{\"type\":\"Point\",\"coordinates\":[100.0,5.0,123]}",
				GeoJsonObject.class);
		Point point = (Point)value;
	...
	public void itShouldSerializeAPointWithAltitude() throws Exception {
		...
		TestUtils.compareAsNodes(point, "{\"type\":\"Point\",\"coordinates\":[100.0,10.0,256.0]}");
	}

	@Test
	public void itShouldDeserializeAPointWithAdditionalAttributes() throws IOException {
		GeoJsonObject value = TestUtils.getMapper().readValue("{\"type\":\"Point\",\"coordinates\":[100.0,5.0,123,456,789.2]}",
				GeoJsonObject.class);
		Point point = (Point)value;
